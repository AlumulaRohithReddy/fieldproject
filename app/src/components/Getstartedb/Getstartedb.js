...
function Getstartedb() {
  return (
    ...
    <div className='main2'>
        ...
        <div className='card1'>
            <Link className='li'>Engagement</Link>
            <Link className='li'>Haldi</Link>
            <Link className='li'>Sangeet</Link>
            <Link className='li'>Reception</Link>
            <Link className='li'>Wedding</Link>
        </div>       
    </div>
